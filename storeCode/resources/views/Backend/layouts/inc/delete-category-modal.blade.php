<div class="modal fade" id="delete_category_modal_id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" style="max-width: 500px!important;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <p class="text-uppercase mt-3"><b>Delete Category</b></p>
