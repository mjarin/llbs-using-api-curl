<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/dashboard') }}" class="brand-link">
        <h4 class="brand-text text-white font-weight-bold" style="font-size:20px!important;">www.lolonarboson.com</h4>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image" style="margin-left:30%;">
                <img src="{{ asset('backend/dist/img/logo-lb-f.jpg') }}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
...
{{--
                ...
                {{-- <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ url('/attribute-list') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>Attribute List</p>
                            </a>
                        </li>
