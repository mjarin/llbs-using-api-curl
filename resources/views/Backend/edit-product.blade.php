                    ...
                    <div class="col-lg-8">
                        <form action="{{url('update-product/'.$product->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control"  name ="product_name" value="{{$product->name}}" id ="product_name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="category" class="col-sm-4 control-label">Slect Category </label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="summernote" class="col-sm-4 col-form-label">Description</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name ="selling_price" value="{{$product->selling_price}}" id ="selling_price">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="deal" class="col-sm-4 col-form-label">Deal</label>
                                <div class="col-sm-8" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="meta_description"  id="meta_description" rows="1" class="form-control">{{$product->meta_description}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="video" class="col-sm-4 control-label">Tutorial Video</label>
                                <div class="col-sm-8">

                                    <textarea name="video"  id="video"  rows="1" class="form-control">{{$product->video}}</textarea>
                                </div>
                            </div>


                            <div class="form-group row">
                                <label for="input-file-now-custom-3" class="col-sm-4 control-label">Cover Image</label>
                                <div class="col-sm-8">
...
{{--  --}}
                           {{-- <div class="row mt-2 mb-2 ml-5">
                                <label for="img" class="col-sm-4 col-form-label"></label>
                                <div class="col-sm-8">
                            @if($product->image)
                            <img src="{{asset('assets/img/gallery/'.$product->image)}}" alt="product image" height="60" width="60" id="img">
                            @endif
                        </div>
                    </div> --}}
